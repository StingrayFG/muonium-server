...
router.post('/create', authMw.authenticateJWT, driveMw.checkDrive, folderMw.checkParentFolder, folderMw.checkIfNameIsUsed, folderController.createFolder);
...
router.put('/rename', authMw.authenticateJWT, driveMw.checkDrive, folderMw.checkParentFolder, folderMw.checkFolderUuid, folderMw.checkIfNameIsUsed, folderController.renameFolder);

router.put('/move', authMw.authenticateJWT, driveMw.checkDrive, folderMw.checkParentFolder, folderMw.checkFolderUuid, folderMw.checkIfNameIsUsed, folderController.moveFolder);

router.put('/remove', authMw.authenticateJWT, driveMw.checkDrive, folderMw.checkFolderUuid, folderController.removeFolder);

router.put('/recover', authMw.authenticateJWT, driveMw.checkDrive, folderMw.checkFolderUuid, folderMw.checkIfNameIsUsed, folderController.recoverFolder);
